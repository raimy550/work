...
public class PrinterCmd
{
    ...
    /// <returns></returns>
    public static String CMD_TextAlign(int align)
    {
    ...
    /// <returns></returns>
    public static String CMD_FontSize_BTP_M280(int size)
    {
        String _cmdstr = "";
        //只有0和1两种模式
        int fontsize = size;
    ...
    /// <param name="size">0:取消倍宽倍高模式  1:倍高模式 2:倍宽模式 3:两倍大小</param>
    /// <returns></returns>
    public static String CMD_FontSize_BTP_M2801(int size)
    {
        String _cmdstr = "";
        //只有0和1两种模式
        int fontsize = size;
    ...
    /// <returns></returns>
    public static String CMD_PageGO(int line)
    {
  ...
  /// <summary>
    /// 走纸
    /// </summary>
    /// <param name="line">走纸的像素点行数</param>
    /// <returns></returns>
    public String CMD_PageGOBmp(int line)
    {
        return new StringBuffer().append((char)27).append((char)74).append((char)line).toString();
    }
    ...
    /// </summary>
    /// <returns></returns>
    public static String CMD_GetType()
    {
        return new StringBuffer().append((char)27).append((char)73).append((char)49).toString();
    }
  ...
  /// <summary>
    ...
    /// </summary>
    /// <returns></returns>
    public static String CMD_GetPrinterState()
    {
        return new StringBuffer().append((char)16).append((char)4).append((char)1).toString();
    }
    ...
    /// 第八位：固定为0
    /// <returns></returns>
    public static String CMD_ReturnStatus(int num)
    {
    ...
    /// <returns></returns>
    public static String CMD_TiaoMaHeight(int num)
    {
    ...
    /// <param name="num"></param>
    /// <returns></returns>
    public static String CMD_TiaoMaWidth(int num)
    {
    ...
    /// <returns></returns>
    public static String CMD_TiaoMaWeiZi(int num)
    {
    ...
    /// <returns></returns>
    public static String CMD_TiaoMaPrint(String numstr)
    {
